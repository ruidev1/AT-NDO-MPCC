...
function xp=SimTimeStep(x,u,Ts,ModelParams, disturbance)
%x state
%u input
%Ts sampling time
x0=x;

[~,inivt]=ode45(@(t,x)fx_bicycle(t,x,u,ModelParams, disturbance),[0 Ts],x0);
xp=inivt(end,:);
return

function xdot=fx_bicycle(t,x,u,ModelParams, disturbance)
