...
function [x, u, new_b, exitflag,info] = optimizer_mpcc(TrackMPC,MPC_vars,ModelParams,n_cars, Y, x, u,  x0, u0, dhat)
    ...
    [xpred, upred,dupred,info] = getMPCmatrices(TrackMPC.traj,MPC_vars,ModelParams,new_b,x,u,x0,u0,dhat);
